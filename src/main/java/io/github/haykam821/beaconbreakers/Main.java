...
public class Main implements ModInitializer {
	...
	public static final GameType<BeaconBreakersConfig> BEACON_BREAKERS_TYPE = GameType.register(BEACON_BREAKERS_ID, BeaconBreakersWaitingPhase::open, BeaconBreakersConfig.CODEC);
